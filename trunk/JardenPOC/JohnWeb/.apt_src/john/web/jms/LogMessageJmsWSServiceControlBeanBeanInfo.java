...
public class LogMessageJmsWSServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    public LogMessageJmsWSServiceControlBeanBeanInfo()
    {
        super(john.web.jms.LogMessageJmsWSServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected LogMessageJmsWSServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(john.web.jms.LogMessageJmsWSServiceControlBean.class);
        bd.setName( "LogMessageJmsWSServiceControlBean" );
        bd.setDisplayName( "LogMessageJmsWSServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for secureLogMessage(message_arg)
        //
        __bc_paramNames = _methodParamMap.get(_secureLogMessageMethod);
        __bc_paramDescriptors = new ParameterDescriptor[__bc_paramNames.length];
        for (int j = 0; j < __bc_paramNames.length; j++)
        {
            __bc_paramDescriptors[j] = new ParameterDescriptor();
        ...
        md = new MethodDescriptor(_secureLogMessageMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , john.web.jms.LogMessageJmsWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = john.web.jms.LogMessageJmsWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            john.web.jms.LogMessageJmsWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            john.web.jms.LogMessageJmsWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            john.web.jms.LogMessageJmsWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
