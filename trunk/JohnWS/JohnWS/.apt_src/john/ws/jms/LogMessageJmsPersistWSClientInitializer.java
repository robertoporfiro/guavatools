...
public class LogMessageJmsPersistWSClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _logMessageDBField = john.ws.jms.LogMessageJmsPersistWS.class.getDeclaredField("logMessageDB");
    ...
    john.ws.jms.LogMessageJmsPersistWS client)
    {
        try
        {
            String __bc_id;
    ...
    public static void initialize(ControlBeanContext cbc, john.ws.jms.LogMessageJmsPersistWS client)
    {
