...
public class HelloJmsWSServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    public HelloJmsWSServiceControlBeanBeanInfo()
    {
        super(john.web.jms.HelloJmsWSServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected HelloJmsWSServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(john.web.jms.HelloJmsWSServiceControlBean.class);
        bd.setName( "HelloJmsWSServiceControlBean" );
        bd.setDisplayName( "HelloJmsWSServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , john.web.jms.HelloJmsWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = john.web.jms.HelloJmsWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            john.web.jms.HelloJmsWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            john.web.jms.HelloJmsWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            john.web.jms.HelloJmsWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
