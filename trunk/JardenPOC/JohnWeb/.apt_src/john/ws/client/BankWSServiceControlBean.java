...
implements john.ws.client.BankWSServiceControl
{
    static final Method _debitMethod;
    ...
    static
    {
        try
        {
            _debitMethod = john.ws.client.BankWSServiceControl.class.getMethod("debit", new Class [] {java.lang.String.class, double.class});
            _methodParamMap.put(_debitMethod, new String [] { "account_arg", "amount_arg" });
            _Callback_onAsyncFailureEvent = john.ws.client.BankWSServiceControl.Callback.class.getMethod("onAsyncFailure", new Class [] {java.lang.String.class, java.lang.Object[].class});
    ...
    */
    ...
    {
        this(context, id, props, john.ws.client.BankWSServiceControl.class);
    }
    ...
    */
    protected BankWSServiceControlBean(ControlBeanContext context, String id, PropertyMap props, Class controlClass)
    {
        ...
        //
        setEventNotifier(john.ws.client.BankWSServiceControl.Callback.class, new CallbackNotifier());
    }
    ...
    */
    ...
    /**
    * Implements john.ws.client.BankWSServiceControl.debit
    */
    public  void debit(java.lang.String account_arg, double amount_arg) 
    {
        Object [] __bc_argArray = new Object[] { account_arg, amount_arg };
        Throwable __bc_thrown = null;
        Extensible __bc_target = (Extensible)ensureControl();
        
        try
        {
            preInvoke(_debitMethod, __bc_argArray);
            
            __bc_target.invoke(_debitMethod, __bc_argArray)
            ;
        }
        ...
        {
            Object __bc_rv = null;
            postInvoke(_debitMethod, __bc_argArray, __bc_rv, __bc_thrown);
        }
    }
    ...
    */
    ...
    implements john.ws.client.BankWSServiceControl.Callback, java.io.Serializable
    {
        ...
        public void onAsyncFailure(java.lang.String arg0, java.lang.Object[] arg1) 
        {
            ...
            CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.ws.client.BankWSServiceControl.Callback.class);
            
            john.ws.client.BankWSServiceControl.Callback __bc_listener = (john.ws.client.BankWSServiceControl.Callback)__bc_notifier.getListener();
    ...
    */
    public synchronized void addCallbackListener(john.ws.client.BankWSServiceControl.Callback listener)
    ...
    */
    public synchronized void removeCallbackListener(john.ws.client.BankWSServiceControl.Callback listener)
    {
        CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.ws.client.BankWSServiceControl.Callback.class);
    ...
    */
    public synchronized john.ws.client.BankWSServiceControl.Callback [] getCallbackListeners()
    {
        CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.ws.client.BankWSServiceControl.Callback.class);
        john.ws.client.BankWSServiceControl.Callback [] __bc_listeners = new john.ws.client.BankWSServiceControl.Callback[__bc_notifier.getListenerCount()];
