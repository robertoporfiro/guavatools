...
public class CallbackWSServiceControlBean
extends com.bea.control.ServiceControlBean
implements john.ws.client.CallbackWSServiceControl
{
    ...
    static
    {
        try
        {
            _delayedHelloMethod = john.ws.client.CallbackWSServiceControl.class.getMethod("delayedHello", new Class [] {java.lang.String.class, int.class});
            _methodParamMap.put(_delayedHelloMethod, new String [] { "name_arg", "delay_arg" });
            _Callback_onAsyncFailureEvent = john.ws.client.CallbackWSServiceControl.Callback.class.getMethod("onAsyncFailure", new Class [] {java.lang.String.class, java.lang.Object[].class});
            _methodParamMap.put(_Callback_onAsyncFailureEvent, new String [] { "arg0", "arg1" });
            _Callback_helloCallbackEvent = john.ws.client.CallbackWSServiceControl.Callback.class.getMethod("helloCallback", new Class [] {java.lang.String.class});
    ...
    */
    public CallbackWSServiceControlBean(ControlBeanContext context, String id, PropertyMap props)
    {
        this(context, id, props, john.ws.client.CallbackWSServiceControl.class);
    }
    ...
    */
    public CallbackWSServiceControlBean()
    {
        this(null, null, null);
    }
    ...
    */
    protected CallbackWSServiceControlBean(ControlBeanContext context, String id, PropertyMap props, Class controlClass)
    {
        ...
        //
        setEventNotifier(john.ws.client.CallbackWSServiceControl.Callback.class, new CallbackNotifier());
    }
    ...
    */
    ...
    /**
    * Implements john.ws.client.CallbackWSServiceControl.delayedHello
    */
    ...
    */
    ...
    implements john.ws.client.CallbackWSServiceControl.Callback, java.io.Serializable
    {
        ...
        public void onAsyncFailure(java.lang.String arg0, java.lang.Object[] arg1) 
        {
            ...
            CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.ws.client.CallbackWSServiceControl.Callback.class);
            
            john.ws.client.CallbackWSServiceControl.Callback __bc_listener = (john.ws.client.CallbackWSServiceControl.Callback)__bc_notifier.getListener();
        ...
        throws org.apache.beehive.controls.spi.svc.InterceptorPivotException
        {
            for ( String __bc_n : interceptors )
            {
                ...
                try
                {
                    __bc_i.preEvent( CallbackWSServiceControlBean.this, john.ws.client.CallbackWSServiceControl.Callback.class , method, argArray );
                }
                catch (org.apache.beehive.controls.spi.svc.InterceptorPivotException __bc_ipe)
                {
        ...
        private void postEvent(Method method, Object[] argArray, Object retval, Throwable t, String[] interceptors, String pivotedInterceptor)
        {
            for (int __bc_cnt = interceptors.length - 1; __bc_cnt >= 0; __bc_cnt--)
            {
                ...
                if (pivotedInterceptor == null || __bc_n.equals(pivotedInterceptor))
                {
                    ...
                    org.apache.beehive.controls.spi.svc.Interceptor __bc_i = ensureInterceptor( __bc_n );
                    __bc_i.postEvent( CallbackWSServiceControlBean.this, john.ws.client.CallbackWSServiceControl.Callback.class , method, argArray, retval, t );
                }
            }
        }
    }
    ...
    */
    public synchronized void addCallbackListener(john.ws.client.CallbackWSServiceControl.Callback listener)
    ...
    */
    public synchronized void removeCallbackListener(john.ws.client.CallbackWSServiceControl.Callback listener)
    {
        CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.ws.client.CallbackWSServiceControl.Callback.class);
    ...
    */
    public synchronized john.ws.client.CallbackWSServiceControl.Callback [] getCallbackListeners()
    {
        CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.ws.client.CallbackWSServiceControl.Callback.class);
        john.ws.client.CallbackWSServiceControl.Callback [] __bc_listeners = new john.ws.client.CallbackWSServiceControl.Callback[__bc_notifier.getListenerCount()];
