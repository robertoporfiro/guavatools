...
public interface ProductDB extends JdbcControl {
	...
	@JdbcControl.SQL(statement="SELECT 'Joe' as supplier, code, name, description, price FROM Product WHERE code = {code}") 
	public ProductVO getProduct(String code);

	@JdbcControl.SQL(statement="SELECT 'Joe' as supplier, code, name, description, price FROM Product WHERE name like {name}") 
	public ProductVO[] getProductsByName(String name);

	@JdbcControl.SQL(statement="SELECT 'Joe' as supplier, code, name, description, price FROM Product") 
