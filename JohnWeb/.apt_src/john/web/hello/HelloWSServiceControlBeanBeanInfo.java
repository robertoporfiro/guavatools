...
public class HelloWSServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    public HelloWSServiceControlBeanBeanInfo()
    {
        super(john.web.hello.HelloWSServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected HelloWSServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(john.web.hello.HelloWSServiceControlBean.class);
        bd.setName( "HelloWSServiceControlBean" );
        bd.setDisplayName( "HelloWSServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for longHello(name_arg, delay_arg)
        //
        __bc_paramNames = _methodParamMap.get(_longHelloMethod);
        __bc_paramDescriptors = new ParameterDescriptor[__bc_paramNames.length];
        for (int j = 0; j < __bc_paramNames.length; j++)
        {
            __bc_paramDescriptors[j] = new ParameterDescriptor();
        ...
        md = new MethodDescriptor(_longHelloMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
        
        //
        // Declare MethodDescriptor for samlHello(name_arg)
        //
        __bc_paramNames = _methodParamMap.get(_samlHelloMethod);
        __bc_paramDescriptors = new ParameterDescriptor[__bc_paramNames.length];
        for (int j = 0; j < __bc_paramNames.length; j++)
        {
            __bc_paramDescriptors[j] = new ParameterDescriptor();
        ...
        md = new MethodDescriptor(_samlHelloMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , john.web.hello.HelloWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = john.web.hello.HelloWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            john.web.hello.HelloWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            john.web.hello.HelloWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            john.web.hello.HelloWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
