...
public class BankWSServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    static
    {
        try
        {
            _transferMethod = john.web.bank.BankWSServiceControl.class.getMethod("transfer", new Class [] {java.lang.String.class, java.lang.String.class, java.lang.String.class, double.class});
            _methodParamMap.put(_transferMethod, new String [] { "fromName_arg", "password_arg", "toName_arg", "amount_arg" });
            _changePasswordMethod = john.web.bank.BankWSServiceControl.class.getMethod("changePassword", new Class [] {java.lang.String.class, java.lang.String.class, java.lang.String.class});
            _methodParamMap.put(_changePasswordMethod, new String [] { "userName_arg", "oldPassword_arg", "newPassword_arg" });
            _getTransactionLogMethod = john.web.bank.BankWSServiceControl.class.getMethod("getTransactionLog", new Class [] {java.lang.String.class, java.lang.String.class});
            _methodParamMap.put(_getTransactionLogMethod, new String [] { "userName_arg", "password_arg" });
            _getBalanceMethod = john.web.bank.BankWSServiceControl.class.getMethod("getBalance", new Class [] {java.lang.String.class, java.lang.String.class});
            _methodParamMap.put(_getBalanceMethod, new String [] { "userName_arg", "password_arg" });
            _Callback_onAsyncFailureEvent = john.web.bank.BankWSServiceControl.Callback.class.getMethod("onAsyncFailure", new Class [] {java.lang.String.class, java.lang.Object[].class});
    ...
    */
    public BankWSServiceControlBeanBeanInfo()
    {
        super(john.web.bank.BankWSServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected BankWSServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(john.web.bank.BankWSServiceControlBean.class);
        bd.setName( "BankWSServiceControlBean" );
        bd.setDisplayName( "BankWSServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for transfer(fromName_arg, password_arg, toName_arg, amount_arg)
        //
        __bc_paramNames = _methodParamMap.get(_transferMethod);
        ...
        md = new MethodDescriptor(_transferMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
        
        //
        // Declare MethodDescriptor for changePassword(userName_arg, oldPassword_arg, newPassword_arg)
        //
        __bc_paramNames = _methodParamMap.get(_changePasswordMethod);
        __bc_paramDescriptors = new ParameterDescriptor[__bc_paramNames.length];
        for (int j = 0; j < __bc_paramNames.length; j++)
        {
            __bc_paramDescriptors[j] = new ParameterDescriptor();
        ...
        md = new MethodDescriptor(_changePasswordMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
        
        //
        // Declare MethodDescriptor for getTransactionLog(userName_arg, password_arg)
        //
        __bc_paramNames = _methodParamMap.get(_getTransactionLogMethod);
        __bc_paramDescriptors = new ParameterDescriptor[__bc_paramNames.length];
        for (int j = 0; j < __bc_paramNames.length; j++)
        {
            __bc_paramDescriptors[j] = new ParameterDescriptor();
        ...
        md = new MethodDescriptor(_getTransactionLogMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
        
        //
        // Declare MethodDescriptor for getBalance(userName_arg, password_arg)
        //
        __bc_paramNames = _methodParamMap.get(_getBalanceMethod);
        __bc_paramDescriptors = new ParameterDescriptor[__bc_paramNames.length];
        for (int j = 0; j < __bc_paramNames.length; j++)
        {
            __bc_paramDescriptors[j] = new ParameterDescriptor();
        ...
        md = new MethodDescriptor(_getBalanceMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
    ...
    {
        MethodDescriptor [] __bc_methodDescriptors = new MethodDescriptor[38];
        try
        {
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , john.web.bank.BankWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = john.web.bank.BankWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            john.web.bank.BankWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            john.web.bank.BankWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            john.web.bank.BankWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
