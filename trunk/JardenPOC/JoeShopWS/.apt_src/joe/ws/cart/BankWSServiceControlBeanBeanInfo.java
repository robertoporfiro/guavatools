...
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    ...
    {
        super(joe.ws.cart.BankWSServiceControlBean.class);
    }
    ...
    */
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(joe.ws.cart.BankWSServiceControlBean.class);
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , joe.ws.cart.BankWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = joe.ws.cart.BankWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            joe.ws.cart.BankWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            joe.ws.cart.BankWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            joe.ws.cart.BankWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
