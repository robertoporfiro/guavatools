...
public class ProductWSServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    public ProductWSServiceControlBeanBeanInfo()
    {
        super(joe.ws.cart.ProductWSServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected ProductWSServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(joe.ws.cart.ProductWSServiceControlBean.class);
        bd.setName( "ProductWSServiceControlBean" );
        bd.setDisplayName( "ProductWSServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for getMatchingProducts(vo_arg)
        //
        __bc_paramNames = _methodParamMap.get(_getMatchingProductsMethod);
        ...
        md = new MethodDescriptor(_getMatchingProductsMethod, __bc_paramDescriptors);
        ...
        //
        // Declare MethodDescriptor for getProduct(supplier_arg, code_arg)
        //
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , joe.ws.cart.ProductWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
        propDescriptors[index++] = pd;
        
        //
        // add property descriptors for any getter/setters defined in control interface
        //
        pd = new PropertyDescriptor( "allProducts" , joe.ws.cart.ProductWSServiceControlBean.class, "getAllProducts", null);
        propDescriptors[index++] = pd;
    ...
    {
        PropertyDescriptor [] __bc_propDescriptors = new PropertyDescriptor[21];
        try
        {
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = joe.ws.cart.ProductWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            joe.ws.cart.ProductWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            joe.ws.cart.ProductWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            joe.ws.cart.ProductWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
