...
public class LogMessagePlusWSClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _logMessageDBField = john.ws.LogMessagePlusWS.class.getDeclaredField("logMessageDB");
    ...
    john.ws.LogMessagePlusWS client)
    {
        try
        {
            String __bc_id;
    ...
    public static void initialize(ControlBeanContext cbc, john.ws.LogMessagePlusWS client)
    {
