...
public class BankReliableWSServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    public BankReliableWSServiceControlBeanBeanInfo()
    {
        super(john.ws.client.BankReliableWSServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected BankReliableWSServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(john.ws.client.BankReliableWSServiceControlBean.class);
        bd.setName( "BankReliableWSServiceControlBean" );
        bd.setDisplayName( "BankReliableWSServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , john.ws.client.BankReliableWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = john.ws.client.BankReliableWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            john.ws.client.BankReliableWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            john.ws.client.BankReliableWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            john.ws.client.BankReliableWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
