...
public class LogMessageWSClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _logMessageDBField = john.ws.LogMessageWS.class.getDeclaredField("logMessageDB");
    ...
    public static void initialize(ControlBeanContext cbc, john.ws.LogMessageWS client)
    {
