...
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    ...
    {
        super(john.ws.client.BankWSServiceControlBean.class);
    }
    ...
    */
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(john.ws.client.BankWSServiceControlBean.class);
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for debit(account_arg, amount_arg)
        //
        __bc_paramNames = _methodParamMap.get(_debitMethod);
        ...
        md = new MethodDescriptor(_debitMethod, __bc_paramDescriptors);
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , john.ws.client.BankWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = john.ws.client.BankWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            john.ws.client.BankWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            john.ws.client.BankWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            john.ws.client.BankWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
