...
implements john.web.bank.BankWSServiceControl
{
    ...
    */
    ...
    {
        this(context, id, props, john.web.bank.BankWSServiceControl.class);
    }
    ...
    */
    protected BankWSServiceControlBean(ControlBeanContext context, String id, PropertyMap props, Class controlClass)
    {
        ...
        //
        setEventNotifier(john.web.bank.BankWSServiceControl.Callback.class, new CallbackNotifier());
    }
    ...
    */
    ...
    /**
    * Implements john.web.bank.BankWSServiceControl.transfer
    */
    ...
    /**
    * Implements john.web.bank.BankWSServiceControl.changePassword
    */
    ...
    /**
    * Implements john.web.bank.BankWSServiceControl.getTransactionLog
    */
    ...
    /**
    * Implements john.web.bank.BankWSServiceControl.getBalance
    */
    ...
    */
    ...
    implements john.web.bank.BankWSServiceControl.Callback, java.io.Serializable
    {
        ...
        public void onAsyncFailure(java.lang.String arg0, java.lang.Object[] arg1) 
        {
            ...
            CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.web.bank.BankWSServiceControl.Callback.class);
            
            john.web.bank.BankWSServiceControl.Callback __bc_listener = (john.web.bank.BankWSServiceControl.Callback)__bc_notifier.getListener();
    ...
    */
    public synchronized void addCallbackListener(john.web.bank.BankWSServiceControl.Callback listener)
    ...
    */
    public synchronized void removeCallbackListener(john.web.bank.BankWSServiceControl.Callback listener)
    {
        CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.web.bank.BankWSServiceControl.Callback.class);
    ...
    */
    public synchronized john.web.bank.BankWSServiceControl.Callback [] getCallbackListeners()
    {
        CallbackNotifier __bc_notifier = (CallbackNotifier)getEventNotifier(john.web.bank.BankWSServiceControl.Callback.class);
        john.web.bank.BankWSServiceControl.Callback [] __bc_listeners = new john.web.bank.BankWSServiceControl.Callback[__bc_notifier.getListenerCount()];
