...
public class LogMessageJmsWSClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _logMessageDBField = john.ws.jms.LogMessageJmsWS.class.getDeclaredField("logMessageDB");
    ...
    john.ws.jms.LogMessageJmsWS client)
    {
        try
        {
            String __bc_id;
    ...
    public static void initialize(ControlBeanContext cbc, john.ws.jms.LogMessageJmsWS client)
    {
